        ...
        try{
            ...
            for(int i=0;i<papers.getCourseId().length;i++){
                ...
                for(int a=0;a<professional;a++){
                    ...
                    //试卷添加的题目
                    PapersTitle papersTitle = new PapersTitle(null, papers.getId(), technologyDayExercise.getTitle(), technologyDayExercise.getAnalysis(), technologyDayExercise.getSetScore(), technologyDayExercise.getStandardAnswer());
                    //添加题目
